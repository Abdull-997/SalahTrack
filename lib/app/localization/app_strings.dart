...
class AppStrings {
  ...
  static const Map<String, Map<String, String>> _values = {
    ...
    'de': {
      ...
      'todayConfirmedPrayers': 'Heute bestätigte Gebete',
      ...
      'languageChoose': 'Wähle die Sprache für SalahTrack.',
      'german': 'Deutsch',
      'english': 'Englisch',
      'arabic': 'Arabisch',
    ...
    'en': {
      ...
      'todayConfirmedPrayers': 'Prayers confirmed today',
      ...
      'languageChoose': 'Choose the language for SalahTrack.',
      'german': 'German',
      'english': 'English',
      'arabic': 'Arabic',
    ...
    'ar': {
      ...
      'todayConfirmedPrayers': 'الصلوات المؤكدة اليوم',
      ...
      'languageChoose': 'اختر لغة تطبيق SalahTrack.',
      'german': 'الألمانية',
      'english': 'الإنجليزية',
      'arabic': 'العربية',
    ...
    'ur': {
      ...
      'todayConfirmedPrayers': 'آج تصدیق شدہ نمازیں',
      ...
      'languageChoose': 'SalahTrack کے لیے زبان منتخب کریں۔',
      'german': 'جرمن',
      'english': 'انگریزی',
      'arabic': 'عربی',
      'urdu': 'اردو',
    ...
    'ps': {
      ...
      'todayConfirmedPrayers': 'د نن ورځې تایید شوي لمونځونه',
      ...
      'languageChoose': 'د SalahTrack لپاره ژبه وټاکئ.',
      'german': 'جرمني',
      'english': 'انګلیسي',
      'arabic': 'عربي',
      'urdu': 'اردو',
